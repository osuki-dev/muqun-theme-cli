...
<!-- prettier-ignore -->
```json
{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","properties":{"format":{"type":"string","const":"muqun-theme"},"schemaVersion":{"type":"integer","minimum":1,"maximum":9007199254740991},"id":{"$ref":"#/$defs/__schema0"},"name":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[^\\x00-\\x1f\\x7f<>]+$"},"version":{"$ref":"#/$defs/__schema1"},"author":{"type":"string","minLength":1,"maxLength":100,"pattern":"^[^\\x00-\\x1f\\x7f<>]+$"},"license":{"type":"string","minLength":1,"maxLength":100,"pattern":"^[^\\x00-\\x1f\\x7f<>]+$"},"source":{"$ref":"#/$defs/__schema2"},"minAppVersion":{"$ref":"#/$defs/__schema1"},"description":{"type":"string","minLength":1,"maxLength":280,"pattern":"^[^\\x00-\\x1f\\x7f<>]+$"},"tags":{"maxItems":12,"type":"array","items":{"$ref":"#/$defs/__schema0"}},"preview":{"$ref":"#/$defs/__schema0"},"homePresentation":{"type":"object","properties":{"header":{"type":"string","enum":["standard","cover"]},"toolbarBackground":{"type":"boolean"}},"required":["header"],"additionalProperties":false},"variants":{"type":"object","properties":{"light":{"$ref":"#/$defs/__schema3"},"dark":{"$ref":"#/$defs/__schema3"}},"required":["light","dark"],"additionalProperties":false},"materials":{"type":"object","propertyNames":{"type":"string"},"additionalProperties":{"default":"auto","type":"string","enum":["auto","solid","glass"]}},"assets":{"type":"object","propertyNames":{"$ref":"#/$defs/__schema0"},"additionalProperties":{"anyOf":[{"type":"object","properties":{"path":{"type":"string","maxLength":160,"pattern":"^assets\\/[a-zA-Z0-9_-]+\\.(png|jpg|jpeg|webp)$"},"sha256":{"type":"string","pattern":"^[a-f0-9]{64}$"}},"required":["path"],"additionalProperties":false},{"type":"object","properties":{"url":{"$ref":"#/$defs/__schema2"},"sha256":{"type":"string","pattern":"^[a-f0-9]{64}$"}},"required":["url"],"additionalProperties":false}]}},"decoration":{"$ref":"#/$defs/__schema6"},"icons":{"type":"object","propertyNames":{"type":"string"},"additionalProperties":{"anyOf":[{"type":"object","properties":{"asset":{"$ref":"#/$defs/__schema0"},"render":{"default":"template","type":"string","enum":["template","original"]}},"required":["asset","render"],"additionalProperties":false},{"type":"null"}]}},"variantDecorations":{"type":"object","properties":{"light":{"$ref":"#/$defs/__schema6"},"dark":{"$ref":"#/$defs/__schema6"}},"additionalProperties":false},"homeIdentity":{"type":"object","properties":{"name":{"anyOf":[{"$ref":"#/$defs/__schema11"},{"type":"object","properties":{"mode":{"type":"string","const":"custom"},"text":{"type":"string","minLength":1,"maxLength":40,"pattern":"^[^\\x00-\\x1f\\x7f<>]+$"}},"required":["mode","text"],"additionalProperties":false}]},"logo":{"anyOf":[{"$ref":"#/$defs/__schema11"},{"type":"object","properties":{"mode":{"type":"string","const":"custom"},"asset":{"$ref":"#/$defs/__schema0"}},"required":["mode","asset"],"additionalProperties":false}]},"artwork":{"$ref":"#/$defs/__schema11"}},"additionalProperties":false}},"required":["format","schemaVersion","id","name","version","variants"],"additionalProperties":false,"$defs":{"__schema0":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[a-z][a-z0-9-]*$"},"__schema1":{"type":"string","maxLength":32,"pattern":"^\\d+\\.\\d+\\.\\d+$"},"__schema2":{"type":"string","maxLength":2048,"pattern":"^https:\\/\\/[^\\s]+$"},"__schema3":{"type":"object","properties":{"colors":{"type":"object","properties":{"background":{"$ref":"#/$defs/__schema4"},"surface":{"$ref":"#/$defs/__schema4"},"surfaceRaised":{"$ref":"#/$defs/__schema4"},"border":{"$ref":"#/$defs/__schema4"},"borderStrong":{"$ref":"#/$defs/__schema4"},"text":{"$ref":"#/$defs/__schema4"},"textMuted":{"$ref":"#/$defs/__schema4"},"textSubtle":{"$ref":"#/$defs/__schema4"},"textDisabled":{"$ref":"#/$defs/__schema4"},"primary":{"$ref":"#/$defs/__schema4"},"onPrimary":{"$ref":"#/$defs/__schema4"},"primarySubtle":{"$ref":"#/$defs/__schema5"},"danger":{"$ref":"#/$defs/__schema4"},"dangerSubtle":{"$ref":"#/$defs/__schema5"},"success":{"$ref":"#/$defs/__schema4"},"warning":{"$ref":"#/$defs/__schema4"},"info":{"$ref":"#/$defs/__schema4"}},"required":["background","surface","surfaceRaised","border","borderStrong","text","textMuted","textSubtle","textDisabled","primary","onPrimary","primarySubtle","danger","dangerSubtle","success","warning","info"],"additionalProperties":false},"surfaces":{"type":"object","properties":{"backgroundOpacity":{"type":"number","minimum":0,"maximum":1}},"additionalProperties":false},"terminal":{"type":"object","properties":{"background":{"$ref":"#/$defs/__schema4"},"backgroundOpacity":{"type":"number","minimum":0,"maximum":1},"foreground":{"$ref":"#/$defs/__schema4"},"cursor":{"$ref":"#/$defs/__schema4"},"link":{"$ref":"#/$defs/__schema4"},"selection":{"$ref":"#/$defs/__schema5"},"ansi":{"type":"array","prefixItems":[{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"},{"$ref":"#/$defs/__schema4"}],"items":false,"minItems":16,"maxItems":16}},"required":["background","foreground","cursor","link","selection","ansi"],"additionalProperties":false}},"required":["colors","terminal"],"additionalProperties":false},"__schema4":{"type":"string","pattern":"^#[0-9a-fA-F]{6}$"},"__schema5":{"type":"string","pattern":"^#[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$"},"__schema6":{"type":"object","propertyNames":{"type":"string"},"additionalProperties":{"anyOf":[{"type":"object","properties":{"asset":{"$ref":"#/$defs/__schema0"},"fit":{"$ref":"#/$defs/__schema7"},"opacity":{"$ref":"#/$defs/__schema8"},"focalPoint":{"$ref":"#/$defs/__schema9"},"compact":{"anyOf":[{"$ref":"#/$defs/__schema10"},{"type":"null"}]},"regular":{"anyOf":[{"$ref":"#/$defs/__schema10"},{"type":"null"}]}},"required":["asset"],"additionalProperties":false},{"type":"null"}]}},"__schema7":{"type":"string","enum":["cover","contain","tile"]},"__schema8":{"type":"number","minimum":0,"maximum":1},"__schema9":{"type":"object","properties":{"x":{"type":"number","minimum":0,"maximum":1},"y":{"type":"number","minimum":0,"maximum":1}},"required":["x","y"],"additionalProperties":false},"__schema10":{"type":"object","properties":{"asset":{"$ref":"#/$defs/__schema0"},"fit":{"$ref":"#/$defs/__schema7"},"opacity":{"$ref":"#/$defs/__schema8"},"focalPoint":{"$ref":"#/$defs/__schema9"}},"required":["asset"],"additionalProperties":false},"__schema11":{"anyOf":[{"type":"object","properties":{"mode":{"type":"string","const":"default"}},"required":["mode"],"additionalProperties":false},{"type":"object","properties":{"mode":{"type":"string","const":"hidden"}},"required":["mode"],"additionalProperties":false}]}}}
```
