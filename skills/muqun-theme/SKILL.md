...
<!-- prettier-ignore -->
```json
{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","properties":{"format":{"type":"string","const":"muqun-theme"},"schemaVersion":{"type":"integer","minimum":1,"maximum":9007199254740991},"id":{"$ref":"#/$defs/__schema0"},"name":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[^\\x00-\\x1f\\x7f<>]+$"},"version":{"$ref":"#/$defs/__schema1"},"author":{"type":"string","minLength":1,"maxLength":100,"pattern":"^[^\\x00-\\x1f\\x7f<>]+$"},"license":{"type":"string","minLength":1,"maxLength":100,"pattern":"^[^\\x00-\\x1f\\x7f<>]+$"},"source":{"$ref":"#/$defs/__schema2"},"minAppVersion":{"$ref":"#/$defs/__schema1"},"description":{"type":"string","minLength":1,"maxLength":280,"pattern":"^[^\\x00-\\x1f\\x7f<>]+$"},"tags":{"maxItems":12,"type":"array","items":{"$ref":"#/$defs/__schema0"}},"preview":{"$ref":"#/$defs/__schema0"},"homePresentation":{"type":"object","properties":{"header":{"type":"string","enum":["standard","cover"]},"toolbarBackground":{"type":"boolean"}},"required":["header"],"additionalProperties":false},"effects":{"$ref":"#/$defs/__schema3"},"variants":{"type":"object","properties":{"light":{"$ref":"#/$defs/__schema4"},"dark":{"$ref":"#/$defs/__schema4"}},"required":["light","dark"],"additionalProperties":false},"materials":{"type":"object","propertyNames":{"type":"string"},"additionalProperties":{"default":"auto","type":"string","enum":["auto","solid","glass"]}},"assets":{"type":"object","propertyNames":{"$ref":"#/$defs/__schema0"},"additionalProperties":{"anyOf":[{"type":"object","properties":{"path":{"type":"string","maxLength":160,"pattern":"^assets\\/[a-zA-Z0-9_-]+\\.(png|jpg|jpeg|webp)$"},"sha256":{"type":"string","pattern":"^[a-f0-9]{64}$"}},"required":["path"],"additionalProperties":false},{"type":"object","properties":{"url":{"$ref":"#/$defs/__schema2"},"sha256":{"type":"string","pattern":"^[a-f0-9]{64}$"}},"required":["url"],"additionalProperties":false}]}},"decoration":{"$ref":"#/$defs/__schema7"},"icons":{"type":"object","propertyNames":{"type":"string"},"additionalProperties":{"anyOf":[{"type":"object","properties":{"asset":{"$ref":"#/$defs/__schema0"},"render":{"default":"template","type":"string","enum":["template","original"]}},"required":["asset","render"],"additionalProperties":false},{"type":"null"}]}},"variantDecorations":{"type":"object","properties":{"light":{"$ref":"#/$defs/__schema7"},"dark":{"$ref":"#/$defs/__schema7"}},"additionalProperties":false},"homeIdentity":{"type":"object","properties":{"name":{"anyOf":[{"$ref":"#/$defs/__schema12"},{"type":"object","properties":{"mode":{"type":"string","const":"custom"},"text":{"type":"string","minLength":1,"maxLength":40,"pattern":"^[^\\x00-\\x1f\\x7f<>]+$"}},"required":["mode","text"],"additionalProperties":false}]},"logo":{"anyOf":[{"$ref":"#/$defs/__schema12"},{"type":"object","properties":{"mode":{"type":"string","const":"custom"},"asset":{"$ref":"#/$defs/__schema0"}},"required":["mode","asset"],"additionalProperties":false}]},"artwork":{"$ref":"#/$defs/__schema12"}},"additionalProperties":false}},"required":["format","schemaVersion","id","name","version","variants"],"additionalProperties":false,"$defs":{"__schema0":{"type":"string","minLength":1,"maxLength":64,"pattern":"^[a-z][a-z0-9-]*$"},"__schema1":{"type":"string","maxLength":32,"pattern":"^\\d+\\.\\d+\\.\\d+$"},"__schema2":{"type":"string","maxLength":2048,"pattern":"^https:\\/\\/[^\\s]+$"},"__schema3":{"type":"object","properties":{"ambient":{"default":"none","type":"string","enum":["none","rain","particles","scanlines","bloom","dust","embers","snow","stars"]},"intensity":{"type":"number","minimum":0,"maximum":1},"speed":{"type":"number","minimum":0,"maximum":2}},"required":["ambient"],"additionalProperties":false},"__schema4":{"type":"object","properties":{"colors":{"type":"object","properties":{"background":{"$ref":"#/$defs/__schema5"},"surface":{"$ref":"#/$defs/__schema5"},"surfaceRaised":{"$ref":"#/$defs/__schema5"},"border":{"$ref":"#/$defs/__schema5"},"borderStrong":{"$ref":"#/$defs/__schema5"},"text":{"$ref":"#/$defs/__schema5"},"textMuted":{"$ref":"#/$defs/__schema5"},"textSubtle":{"$ref":"#/$defs/__schema5"},"textDisabled":{"$ref":"#/$defs/__schema5"},"primary":{"$ref":"#/$defs/__schema5"},"onPrimary":{"$ref":"#/$defs/__schema5"},"primarySubtle":{"$ref":"#/$defs/__schema6"},"danger":{"$ref":"#/$defs/__schema5"},"dangerSubtle":{"$ref":"#/$defs/__schema6"},"success":{"$ref":"#/$defs/__schema5"},"warning":{"$ref":"#/$defs/__schema5"},"info":{"$ref":"#/$defs/__schema5"}},"required":["background","surface","surfaceRaised","border","borderStrong","text","textMuted","textSubtle","textDisabled","primary","onPrimary","primarySubtle","danger","dangerSubtle","success","warning","info"],"additionalProperties":false},"surfaces":{"type":"object","properties":{"backgroundOpacity":{"type":"number","minimum":0,"maximum":1}},"additionalProperties":false},"effects":{"$ref":"#/$defs/__schema3"},"terminal":{"type":"object","properties":{"background":{"$ref":"#/$defs/__schema5"},"backgroundOpacity":{"type":"number","minimum":0,"maximum":1},"foreground":{"$ref":"#/$defs/__schema5"},"cursor":{"$ref":"#/$defs/__schema5"},"link":{"$ref":"#/$defs/__schema5"},"selection":{"$ref":"#/$defs/__schema6"},"ansi":{"type":"array","prefixItems":[{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"},{"$ref":"#/$defs/__schema5"}],"items":false,"minItems":16,"maxItems":16}},"required":["background","foreground","cursor","link","selection","ansi"],"additionalProperties":false}},"required":["colors","terminal"],"additionalProperties":false},"__schema5":{"type":"string","pattern":"^#[0-9a-fA-F]{6}$"},"__schema6":{"type":"string","pattern":"^#[0-9a-fA-F]{6}([0-9a-fA-F]{2})?$"},"__schema7":{"type":"object","propertyNames":{"type":"string"},"additionalProperties":{"anyOf":[{"type":"object","properties":{"asset":{"$ref":"#/$defs/__schema0"},"fit":{"$ref":"#/$defs/__schema8"},"opacity":{"$ref":"#/$defs/__schema9"},"focalPoint":{"$ref":"#/$defs/__schema10"},"compact":{"anyOf":[{"$ref":"#/$defs/__schema11"},{"type":"null"}]},"regular":{"anyOf":[{"$ref":"#/$defs/__schema11"},{"type":"null"}]}},"required":["asset"],"additionalProperties":false},{"type":"null"}]}},"__schema8":{"type":"string","enum":["cover","contain","tile"]},"__schema9":{"type":"number","minimum":0,"maximum":1},"__schema10":{"type":"object","properties":{"x":{"type":"number","minimum":0,"maximum":1},"y":{"type":"number","minimum":0,"maximum":1}},"required":["x","y"],"additionalProperties":false},"__schema11":{"type":"object","properties":{"asset":{"$ref":"#/$defs/__schema0"},"fit":{"$ref":"#/$defs/__schema8"},"opacity":{"$ref":"#/$defs/__schema9"},"focalPoint":{"$ref":"#/$defs/__schema10"}},"required":["asset"],"additionalProperties":false},"__schema12":{"anyOf":[{"type":"object","properties":{"mode":{"type":"string","const":"default"}},"required":["mode"],"additionalProperties":false},{"type":"object","properties":{"mode":{"type":"string","const":"hidden"}},"required":["mode"],"additionalProperties":false}]}}}
```
